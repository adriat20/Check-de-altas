@echo off
REM ======================================================================
REM  Lanzador universal de checks_altasFILTRO_ALTA.py
REM  → No importa dónde esté este .bat: busca el .py por su ruta absoluta
REM ======================================================================

:: 1)  Ruta donde vive el script (.py)
::set "SCRIPT_DIR=C:\Users\Adrian\OneDrive\Escritorio\check_altas"
set "SCRIPT_DIR=C:\Users\X\OneDrive\ESCRITORIO IBERDROLA\PROGRAMACION\Proyecto_Check_Altas"
set "SCRIPT=%SCRIPT_DIR%\checks_altasFILTRO_ALTA.py"
...
:: 4)  Ejecutar el script (sin necesidad de CD)
echo.
echo -----------------------------------------------------------
...
:: 5)  Abrir la carpeta donde generó el Excel para verlo al instante
explorer "%SCRIPT_DIR%"
